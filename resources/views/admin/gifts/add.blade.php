...
<div class="col-xl-12">
    <div class="card bg-secondary border-0 mb-0">
        ...
        <div class="card-body px-lg-5 py-lg-5">
            <!-- Projects table -->
            <form id="add-user-form" method="post" action="{{ route('saveGift') }}" enctype='multipart/form-data'>
                @csrf
                <div class="form-group">
                    <input type="text" class="form-control" placeholder="Name" name="name">
                </div>
                <div class="form-group">
                    <input type="text" class="form-control no_space" placeholder="Points" name="points" maxlength=10>
                </div>
                <div class="form-group">
                ...
                <button class="btn btn-primary my-4">Add Gift</button>
            </form>
        </div>
    </div>
</div>
